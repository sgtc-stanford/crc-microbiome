#!/bin/bash
###Sequencing Reads Mapping, extract unmapped reads & quality control
...
########unmapped reads quality control
fastp -q 15 -u 40 -n 5 -l 36 --detect_adapter_for_pe -G -M 0 -i ${y}_unmapped.fastq -o ${y}_unmapped_QC.fastq
